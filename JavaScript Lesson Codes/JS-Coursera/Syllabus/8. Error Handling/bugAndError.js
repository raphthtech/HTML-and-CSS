bugs will be ignored and program execution will continue

Bugs make our code work differently but it continues with the execution

JS will stop the script if it detects an error.
...
addNums(1,2)
addNums('1',2)
console.log(c + d)// this will give an error because the variables do not exist

types
a. Syntax Error
occurs when you write a piece of code that JS cannot read
